...
const Page = () => {
  ...
  useEffect(()=>{
    if(Ismember){
      console.log("You are member = " + membershipid)
    }else{
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    >
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Access to All Cources </span>
        </li>
    ...
    <div className="rounded-2xl border border-primary p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
        <h2 className="text-lg font-medium text-gray-900">
          Starter
          <span className="sr-only">Plan</span>
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Unlimited Video Streaming </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Only Free cources Access </span>
        </li>
    ...
    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        >
          ...
          <h2 className="mt-2 font-bold">AI-MockUp Interview feature</h2>
